...
<header class="flex justify-between items-center mb-10">
    <div>
        ...
        <p class="text-slate-500 font-medium">Tambahkan kategori baru untuk event Anda.</p>
    </div>
...
<div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-10 max-w-3xl">
    <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="name" value="{{ old('name') }}" placeholder="Contoh: Seminar"
        ...
        <div class="flex justify-end gap-4 pt-4">
            ...
            <button type="submit" class="px-8 py-3 bg-indigo-600 text-white rounded-2xl font-bold hover:bg-indigo-700 transition">Simpan Kategori</button>
        </div>
    </form>
</div>
@endsection
